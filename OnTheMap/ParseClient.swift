...
class ParseClient: NSObject {
    ...
    func taskForPostStudentLocation(name: String, mediaURL: String, completionHandlerForPOST: @escaping (_ results: AnyObject?, _ error: NSError?) -> Void) {
        ...
        request.httpBody = "{\"uniqueKey\": \"1234\", \"firstName\": \"Fickletits\", \"lastName\": \"McGinty\",\"mapString\": \"Palm Desert, CA\", \"mediaURL\": \"https://udacity.com\",\"latitude\": 37.386052, \"longitude\": -122.083851}".data(using: String.Encoding.utf8)
